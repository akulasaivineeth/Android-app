...
import com.example.sportsspace.view.ui.admin.adminhome.Fragments.add_custom_user.AddCustomUser;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getTitle().toString()) {
                    ...
                    case "Add Custom User":
                        fragmentManager
                                .beginTransaction()
                                .replace(R.id.admin_fragment, AddCustomUser.class,null)
                                .setReorderingAllowed(true)
                                .commit();
                        drawerLayout.close();
                        break;
