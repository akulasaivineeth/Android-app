        ...
        reference
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        DatabaseReference approvedUser = reference.child("approved_user").child(f.getUid());
                        DatabaseReference userRef = reference.child("user_requests").child(f.getUid());
                        Log.d("userRef --",userRef.toString());
                        if (approvedUser != null) {
                            //Add data
                            approvedUser.setValue(f);
