    ...
    public void checkIfUserExist(String key , UserData userData) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                boolean isUserReqExist = (snapshot.child("user_requests").child(key).exists());
                boolean isApprovedUserExist = (snapshot.child("approved_user").child(key).exists());

                Log.d("isUserRequest--",String.valueOf(isUserReqExist));
                Log.d("isApprovedUserExist--",String.valueOf(isApprovedUserExist));

                if ( isUserReqExist == false &&
                        isApprovedUserExist == false
                ) {
